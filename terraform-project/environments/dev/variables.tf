...
variable "key_pair_name" {
  description = "Existing EC2 key pair name in this region. CHANGE ME — create via: aws ec2 create-key-pair --key-name automobile-app-dev-key"
  type        = string
}
...
variable "db_name" {
  type    = string
  default = "automobilemanufacturing"
}

variable "db_username" {
  type      = string
  sensitive = true
  default   = "automobile_admin"
}
